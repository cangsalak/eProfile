...
const settingsModules = [
  ...
  { href: '/users/roles', icon: 'fa-user-shield', title: 'สิทธิ์การใช้งาน', description: 'บทบาทและสิทธิ์การเข้าถึงระบบ' },
  { href: '/users/departments', icon: 'fa-building', title: 'หน่วยงาน', description: 'โครงสร้างหน่วยงานและหน่วยย่อย' },

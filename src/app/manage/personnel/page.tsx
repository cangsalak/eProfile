...
export default function ManagePersonnelPage() {
  ...
  const handleDownloadTemplate = () => {
    const ws = XLSX.utils.json_to_sheet([{
      ...
      department: 'ศูนย์เทคโนโลยี',
      subDepartment: 'แผนกซอฟต์แวร์',
      ...
      religion: 'พุทธ',
      officialId: 'OFF-001',
      militaryBranch: 'ทหารบก',
      commissionDate: '2015-05-01',
      currentAddress: '123 ถ.สุขุมวิท กทม.',
      emergencyContactName: 'นายใจดี',
      ...
      try {
        ...
        for (const row of data as any[]) {
          const mappedData = {
            ...
            citizenId: row['citizenId'] || row['เลขบัตรปชช'] || '',
            badgeNo: row['badgeNo'] || row['รหัสบัตร'] || '',
            bloodType: row['bloodType'] || row['กรุ๊ปเลือด'] || '',
            phone: row['phone'] || row['เบอร์โทร'] || '',
            email: row['email'] || row['อีเมล'] || '',
            mobile: row['mobile'] || row['มือถือ'] || '',
            ...
            officialId: row['officialId'] || row['หมายเลขข้าราชการ'] || '',
            ...
            emergencyContactPhone: row['emergencyContactPhone'] || row['เบอร์ผู้ติดต่อฉุกเฉิน'] || '',

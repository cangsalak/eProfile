...
export default function BulkBadgePrintPage() {
  ...
  useEffect(() => {
    ...
    if (idsToPrint.length === 0) {
      alert('ไม่มีรายชื่อที่เลือกไว้สำหรับพิมพ์');
      router.back();
      return;
    }
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 print:bg-white text-slate-800 dark:text-slate-200">
      ...
      <div className="print:hidden max-w-5xl mx-auto pt-10 pb-6 px-4">
      ...
      <div className="max-w-5xl mx-auto px-4 pb-20 print:p-0 print:m-0 print:max-w-none">

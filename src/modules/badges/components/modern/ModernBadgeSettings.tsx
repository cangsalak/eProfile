...
interface ModernBadgeSettingsProps {
  settings: any;
  handleChange: (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>) => void;
}

export default function ModernBadgeSettings({ settings, handleChange }: ModernBadgeSettingsProps) {
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      <div className="pt-2 space-y-3">
        ...
        />
        <Checkbox
          name="badgeShowBarcode"
          label="แสดงแถบบาร์โค้ดสแกน (Barcode)"
          checked={settings.badgeShowBarcode !== 'false'}
          onChange={handleChange}
          id="badgeShowBarcode"
        />
      </div>

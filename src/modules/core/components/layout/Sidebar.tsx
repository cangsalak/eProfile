...
export default function Sidebar({
  ...
  return (
    <aside
      className={`fixed inset-y-0 left-0 z-50 bg-white dark:bg-slate-900 text-slate-700 dark:text-slate-300 border-r border-slate-200 dark:border-slate-800 transform transition-all duration-300 ease-in-out ${
    ...
    >
      ...
      <div className={`flex items-center justify-between h-18 border-b border-slate-200 dark:border-slate-800 shrink-0 transition-all ${
        ...
        <button
          ...
          className="hidden lg:flex text-slate-400 hover:text-slate-700 dark:hover:text-white transition-colors p-1.5 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800"
                  ...
                  {hasSubItems ? (
                    ...
                    >
                      <div className={`flex items-center ${isSidebarCollapsed ? 'justify-center' : 'space-x-3'}`}>
                        <i className={`${item.icon} text-sm ${isSidebarCollapsed ? 'w-auto' : 'w-5 text-center'} ${isExactActive ? 'text-primary-600 dark:text-primary-400' : 'text-slate-400 dark:text-slate-500'}`}></i>
                          ...
                          return (
                            <Link
                              ...
                              className={`flex items-center rounded-lg text-xs font-medium transition-colors ${
                                ...
                                isSubActive
                                  ? 'text-primary-600 dark:text-primary-400 font-bold bg-primary-50 dark:bg-primary-950/40'

...
export default function ManageAuditLogsPage() {
  ...
  const getActionBadge = (action: string) => {
    switch (action) {
      ...
      case 'INSPECT_PAGE':
        return (
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-primary-50 dark:bg-primary-950/50 text-primary-700 dark:text-primary-400 border border-primary-200 dark:border-primary-800/60 rounded-lg text-xs font-bold">
    ...
    >
      <div className="space-y-6">
        ...
        <div className="flex flex-wrap items-center gap-2 shrink-0">
          ...
          <Link
            href="/settings"
            className="px-3 py-2 bg-primary-50 dark:bg-primary-950/60 hover:bg-primary-100 dark:hover:bg-primary-900/60 text-primary-700 dark:text-primary-300 rounded-xl text-xs font-bold transition-all flex items-center gap-1.5"
            title="ตั้งค่าระบบ"
          >

                ...
                inspections.map((item) => (
                  <tr key={item.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/40 transition-colors">
                    ...
                    <td className="py-3.5 px-4 font-medium text-slate-900 dark:text-white">
                      <div>{item.page}</div>
                      <div className="font-mono text-[11px] text-primary-600 dark:text-primary-400">{item.url}</div>
                    </td>
                    ...
                    <td className="py-3.5 px-4 text-right whitespace-nowrap">
                      <button
                        ...
                        className="px-2.5 py-1 bg-primary-50 hover:bg-primary-100 dark:bg-primary-950/40 dark:hover:bg-primary-900/60 text-primary-600 dark:text-primary-300 rounded-lg text-xs font-semibold mr-1.5 transition-colors"
                      >

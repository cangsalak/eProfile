      ...
      <div ref={menuRef} className="fixed bottom-6 right-6 z-40 no-inspect print:hidden">
        ...
        {isMenuOpen && (
          <div className="absolute bottom-14 right-0 w-64 p-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-2xl shadow-2xl space-y-1 animate-fade-in text-xs font-semibold">
            <div className="px-3 py-1.5 border-b border-slate-100 dark:border-slate-800/80 flex items-center justify-between text-[10px] uppercase font-black text-primary-600 dark:text-primary-400 tracking-wider">
              <span>Super Admin Tools</span>
              <span className="bg-primary-100 dark:bg-primary-950 px-1.5 py-0.5 rounded text-[9px]">DIAGNOSTIC</span>
            </div>
            ...
            <button
              ...
              className="w-full flex items-center gap-2.5 px-3 py-2.5 text-left rounded-xl hover:bg-primary-50 dark:hover:bg-primary-950/40 text-primary-700 dark:text-primary-300 transition-colors"
            >
              <div className="w-7 h-7 rounded-lg bg-primary-600 text-white flex items-center justify-center shrink-0 shadow-xs">
            ...
            >
              <div className="w-7 h-7 rounded-lg bg-slate-100 dark:bg-slate-800 flex items-center justify-center shrink-0">
                <i className="fa-solid fa-file-lines text-xs text-primary-500"></i>
              </div>
              <div>
        ...
        <button
          ...
          className={`group flex items-center gap-2 px-3.5 py-2.5 bg-primary-600 hover:bg-primary-500 text-white rounded-2xl shadow-xl shadow-primary-600/30 border border-primary-400/30 transition-all ${
            isMenuOpen ? 'scale-105 ring-2 ring-primary-400/50' : 'hover:scale-105 active:scale-95'
          }`}

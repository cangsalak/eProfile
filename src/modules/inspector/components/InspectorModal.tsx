          ...
          {isScanning ? (
            <div className="py-16 flex flex-col items-center justify-center text-center space-y-5">
              <div className="relative">
                <div className="w-20 h-20 rounded-full border-4 border-primary-500/20 border-t-primary-600 animate-spin"></div>
                <div className="absolute inset-0 flex items-center justify-center text-primary-600 text-xl">
              ...
              <div className="w-full max-w-md space-y-2">
                ...
                {scanProgress && (
                  <div className="space-y-2">
                    ...
                    <p className="text-xs font-mono text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-950/40 py-1 px-3 rounded-lg border border-primary-200 dark:border-primary-800/50">
            ...
            <>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div className="space-y-1">
                    ...
                    <h4 className="text-sm font-bold text-slate-900 dark:text-white flex items-center gap-2">
                      <i className={`fa-solid ${report.isProjectWide ? 'fa-layer-group text-primary-500' : 'fa-file-lines text-primary-500'}`}></i>
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {savedId ? (
                      ...
                      <button
                        ...
                        disabled={isSaving}
                        className="px-4 py-2 bg-primary-600 hover:bg-primary-500 disabled:opacity-50 text-white rounded-xl text-xs font-semibold shadow-sm flex items-center gap-1.5 transition-all"
                      >
                ...
                <div className="bg-slate-50 dark:bg-slate-900/60 p-4 rounded-2xl border border-slate-200/80 dark:border-slate-800 space-y-2">
                  <div className="flex items-center justify-between">
                    <h5 className="text-xs font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                      <i className="fa-solid fa-sitemap text-primary-500"></i> เส้นทางทั้งหมดในโปรเจค ({report.routeSummaries.length} หน้า):
                    </h5>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 bg-primary-50/60 dark:bg-primary-950/30 p-2.5 rounded-2xl border border-primary-200/80 dark:border-primary-800/50">
                {/* Filter Categories */}
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 bg-white dark:bg-slate-800 hover:bg-primary-100 dark:hover:bg-slate-700 text-primary-700 dark:text-primary-300 border border-primary-300 dark:border-primary-700/60 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all shadow-xs"
                    title="ดูเนื้อหา Prompt ก่อนคัดลอก"
                  >
                    <i className="fa-solid fa-robot text-primary-500"></i>
                    <span>ดู Prompt</span>
                  </button>
                </div>
              </div>
              ...
              <div className="space-y-3">
                {filteredFindings.length === 0 ? (
                  ...
                  filteredFindings.map((finding, idx) => (
                    <div
                      key={idx}
                      className="p-4 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 shadow-xs hover:border-primary-300 dark:hover:border-primary-800 transition-all space-y-2"
                    >
                      <div className="flex flex-wrap items-center justify-between gap-2">
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          {finding.url && (
                            <span className="text-xs font-mono font-semibold text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-950/50 px-2 py-0.5 rounded-md border border-primary-100 dark:border-primary-900/50">
                              {finding.url}
                            </span>
                          )}
                        </div>

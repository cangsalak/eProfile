...
export const MaternityLeavePrintForm: React.FC<LeavePrintFormProps> = ({
  ...
  return (
    <PrintFormLayout formCode="ทบ. ๑๐๐ – ๐๐๕" formNumber="แบบ ๔" toPerson={leave.toPerson}>
      {/* Garuda Emblem */}
      ...
      <div className="flex items-baseline mb-2 pl-[2cm]">
        ...
        <Field width="45px">{(leave as any).maternityLeaveTimes || ''}</Field>
        <span className="whitespace-nowrap mx-2">ครั้ง รวม</span>
        <Field width="45px">{(leave as any).maternityLeaveDays || ''}</Field>
      ...
      <div className="text-right text-[10pt] text-slate-500 mt-2">
